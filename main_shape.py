...
while True:
    ...
    if ch ==1:
        ...
        print("Total Squares",total_squares)
        print("Total Circles",total_circle)
        print("Total Triangles",total_triangle)
        print("Total Rectangles",total_rectangle)
    ...
    total_squares=obj.calc_area()
    total_circle=obj.calc_area()
    total_triangle=obj.calc_area()
    total_rectangle=obj.calc_area()
